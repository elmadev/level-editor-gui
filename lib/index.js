...
function () {
  ...
  _createClass(LevelEditorGUI, [{
    ...
    value: function createStatusbar() {
      ...
      this.statusbar.style.cssText = 'position: absolute;left: 0;bottom: 0px;width: 100%;background: black; padding: 10px; color: #ffffff; font-size: 12px;z-index: 15; box-sizing: border-box;';
